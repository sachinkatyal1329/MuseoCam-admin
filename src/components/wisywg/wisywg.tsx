...
class Wiswyg extends Component<any, any> {
  constructor(props) {
    super(props)
  }
...
export default Wiswyg
// class Wisywg extends Component<any, any> {
//   constructor(props) {
//     super(props);
